...
from Projeto.ControleControle.Controle.PreparacaoExecucaoExtracaoTexto import PreparacaoExecucaoExtracaoTexto
from Projeto.ControleControle.Controle.MontagemArquivo import MontagemArquivo
...
class Controle:
    ...
    def preparacoes_execucao(self, type: str):
        if type == 'varredura_web':
